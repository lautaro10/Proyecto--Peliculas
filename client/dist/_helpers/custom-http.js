...
var CustomHttp = /** @class */ (function (_super) {
    ...
    CustomHttp.prototype.get = function (url, options) {
        if (!options) {
            ...
            return _super.prototype.get.call(this, url).catch(this.handleError);
        }
    };
    CustomHttp.prototype.post = function (url, body, options) {
        return _super.prototype.post.call(this, app_config_1.appConfig.apiUrl + url, body).catch(this.handleError);
    };
    CustomHttp.prototype.put = function (url, body, options) {
        return _super.prototype.put.call(this, app_config_1.appConfig.apiUrl + url, body).catch(this.handleError);
    };
